...
public class onboarding extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(onboarding.this, "Set up your food profile to find someone aMAIZing!", Toast.LENGTH_LONG).show();
    ...
    public void logoutUser(View view) {
        auth.signOut();
        Intent intent = new Intent(onboarding.this, OpeningPage.class);
        startActivity(intent);
        finish();
        return;
    }
